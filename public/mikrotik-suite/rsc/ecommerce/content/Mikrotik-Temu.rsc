...
add action=add-dst-to-address-list address-list=Connection-Temu address-list-timeout=1d chain=prerouting content=temu.com dst-address-list=!LOCAL-IP src-address-list=LOCAL-IP comment="// CONNECTION TEMU => {MARKETPLACE}"
add action=add-dst-to-address-list address-list=Connection-Temu address-list-timeout=1d chain=prerouting content=.temu. dst-address-list=!LOCAL-IP src-address-list=LOCAL-IP
