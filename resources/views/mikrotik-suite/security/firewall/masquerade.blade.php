    ...
    <div class="container-fluid px-4 py-4">
        <div class="mb-4 d-flex flex-column align-items-center justify-content-center text-center">
            <h2 class="display-6 fw-bold mb-2 text-white" style="text-shadow: 0 2px 10px rgba(0,0,0,0.3);">
                <i class="bi bi-balloon me-2 text-primary"></i> Masquerade (NAT)
            </h2>
            <p class="lead opacity-75 mb-0" style="max-width: 700px;">
                Enable Internet access for your LAN via WAN.
            </p>
        </div>
                ...
                <div class="col-lg-5">
                    <div class="glass-card h-100">
                        <div class="card-header border-0 bg-transparent pt-4 px-4">
                            <h5 class="card-title fw-bold text-white mb-0">Interface</h5>
                        </div>
                        <div class="card-body p-4">
                            <div class="mb-3">
                                <label class="form-label text-white small text-uppercase">Out Interface (WAN)</label>
...
@push('scripts')
    @vite(['resources/js/pages/mikrotik-suite/security/firewall/masquerade.js'])
@endpush
