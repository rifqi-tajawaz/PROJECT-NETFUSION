...
add action=add-dst-to-address-list address-list=Connection-Snapchat address-list-timeout=1d chain=prerouting protocol=tcp tls-host=*snapchat.com* dst-address-list=!LOCAL-IP src-address-list=LOCAL-IP comment="// CONNECTION SNAPCHAT => {SOCIAL MEDIA}"
add action=add-dst-to-address-list address-list=Connection-Snapchat address-list-timeout=1d chain=prerouting protocol=tcp tls-host=*.snapchat.* dst-address-list=!LOCAL-IP src-address-list=LOCAL-IP
