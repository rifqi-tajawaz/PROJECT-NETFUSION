...
add action=add-dst-to-address-list address-list=Connection-Olx address-list-timeout=1d chain=prerouting protocol=tcp tls-host=*olx.com* dst-address-list=!LOCAL-IP src-address-list=LOCAL-IP comment="// CONNECTION OLX => {MARKETPLACE}"
add action=add-dst-to-address-list address-list=Connection-Olx address-list-timeout=1d chain=prerouting protocol=tcp tls-host=*.olx.* dst-address-list=!LOCAL-IP src-address-list=LOCAL-IP
