...
add action=add-dst-to-address-list address-list=Connection-Tokopedia address-list-timeout=1d chain=prerouting protocol=tcp tls-host=*tokopedia.com* dst-address-list=!LOCAL-IP src-address-list=LOCAL-IP comment="// CONNECTION TOKOPEDIA => {MARKETPLACE}"
add action=add-dst-to-address-list address-list=Connection-Tokopedia address-list-timeout=1d chain=prerouting protocol=tcp tls-host=*.tokopedia.* dst-address-list=!LOCAL-IP src-address-list=LOCAL-IP
