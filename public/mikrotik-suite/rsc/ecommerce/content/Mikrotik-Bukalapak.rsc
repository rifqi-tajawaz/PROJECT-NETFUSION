...
add action=add-dst-to-address-list address-list=Connection-Bukalapak address-list-timeout=1d chain=prerouting content=bukalapak.com dst-address-list=!LOCAL-IP src-address-list=LOCAL-IP comment="// CONNECTION BUKALAPAK => {MARKETPLACE}"
add action=add-dst-to-address-list address-list=Connection-Bukalapak address-list-timeout=1d chain=prerouting content=.bukalapak. dst-address-list=!LOCAL-IP src-address-list=LOCAL-IP
