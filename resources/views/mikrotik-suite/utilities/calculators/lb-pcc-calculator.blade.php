    ...
    <div class="container-fluid px-4 py-4">
        ...
        <div class="mb-4 d-flex flex-column align-items-center justify-content-center text-center">
            <h2 class="display-6 fw-bold mb-2 text-white" style="text-shadow: 0 2px 10px rgba(0,0,0,0.3);">
                <i class="bi bi-diagram-3 me-2 text-info"></i> PCC Load Balancing
            </h2>
            <p class="lead opacity-75 mb-0" style="max-width: 700px;">
                Generate MikroTik Per Connection Classifier (PCC) Load Balancing script for up to 8 WANs.
                Balanced traffic distribution with Failover.
            </p>
        </div>

        <form id="pccForm" data-route="{{ route('mikrotik-suite.utilities.calculators.lb-pcc.calculate') }}">
            <div class="row g-4">
                <!-- Configuration -->
                <div class="col-lg-5">
                    <div class="glass-card h-100">
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="mb-4">
                                ...
                                <small class="text-muted">Interface connected to your local network.</small>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <div class="form-check form-switch mb-2">
                                    <input class="form-check-input" type="checkbox" id="chkDns" name="dns" value="1"
                                        checked>
                                    <label class="form-check-label text-white" for="chkDns">Add Google DNS (8.8.8.8,
                                        8.8.4.4)</label>
                                </div>
                                <div class="form-check form-switch mb-2">
                ...
                <div class="col-lg-7">
                    <div class="glass-card h-100">
                        <div
                            ...
                            <small class="text-muted">Enter Gateway IPs or Interfaces</small>
                        </div>
                        <div class="card-body p-4">
...
@push('scripts')
    @vite(['resources/js/pages/mikrotik-suite/utilities/calculators/lb-pcc-calculator.js'])
@endpush
