    ...
    <div class="d-flex align-items-center justify-content-center min-vh-100 p-4">
        ...
        <div class="glass-card w-100 p-4 p-md-5 animate__animated animate__fadeInUp" style="max-width: 450px;">
            ...
            <div class="text-center mb-5">
                ...
                <h3 class="fw-bold mb-1">Recovery Code</h3>
                <p class="text-muted small">{{ __('auth.recovery_code_message') }}</p>
            </div>
            ...
            <form method="POST" action="{{ route('two-factor.recovery.verify') }}">
                ...
                <div class="mb-4">
                    <label for="recovery_code"
                        class="form-label small text-muted text-uppercase fw-bold text-center w-100">Emergency Recovery
                        Code</label>
                    <input id="recovery_code" type="text"
                        ...
                        name="recovery_code" required autocomplete="one-time-code" autofocus placeholder="XXXXXXXX-XXXXXXXX"
                        style="font-family: monospace; letter-spacing: 0.1em; font-size: 1.2rem; background: rgba(0,0,0,0.3) !important;">
                    @error('recovery_code')
                ...
                <div class="text-center">
                    <p class="mb-0 text-muted small">Have your authenticator?</p>
                    <a href="{{ route('two-factor.challenge') }}" class="text-link-glow fw-bold text-decoration-none">Use
