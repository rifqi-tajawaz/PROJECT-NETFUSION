...
add action=add-dst-to-address-list address-list=Connection-Webex address-list-timeout=1d chain=prerouting protocol=tcp tls-host=*webex.com* dst-address-list=!LOCAL-IP src-address-list=LOCAL-IP comment="// CONNECTION WEBEX => {VIDEO CONPERENCE}"
add action=add-dst-to-address-list address-list=Connection-Webex address-list-timeout=1d chain=prerouting protocol=tcp tls-host=*.webex.* dst-address-list=!LOCAL-IP src-address-list=LOCAL-IP
