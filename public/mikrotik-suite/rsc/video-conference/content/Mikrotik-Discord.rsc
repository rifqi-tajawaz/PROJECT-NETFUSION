...
add action=add-dst-to-address-list address-list=Connection-Discord address-list-timeout=1d chain=prerouting content=discord.com dst-address-list=!LOCAL-IP src-address-list=LOCAL-IP comment="// CONNECTION DISCORD => {VIDEO CONPERENCE}"
add action=add-dst-to-address-list address-list=Connection-Discord address-list-timeout=1d chain=prerouting content=.discord. dst-address-list=!LOCAL-IP src-address-list=LOCAL-IP
