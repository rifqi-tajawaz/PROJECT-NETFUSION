...
add action=add-dst-to-address-list address-list=Connection-Blibli address-list-timeout=1d chain=prerouting protocol=tcp tls-host=*blibli.com* dst-address-list=!LOCAL-IP src-address-list=LOCAL-IP comment="// CONNECTION BLIBLI => {MARKETPLACE}"
add action=add-dst-to-address-list address-list=Connection-Blibli address-list-timeout=1d chain=prerouting protocol=tcp tls-host=*.blibli.* dst-address-list=!LOCAL-IP src-address-list=LOCAL-IP
