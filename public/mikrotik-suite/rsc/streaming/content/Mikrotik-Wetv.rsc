...
add action=add-dst-to-address-list address-list=Connection-Wetv address-list-timeout=1d chain=prerouting content=wetv.vip dst-address-list=!LOCAL-IP src-address-list=LOCAL-IP comment="// CONNECTION WETV => {STREAMING}"
add action=add-dst-to-address-list address-list=Connection-Wetv address-list-timeout=1d chain=prerouting content=.wetv. dst-address-list=!LOCAL-IP src-address-list=LOCAL-IP
