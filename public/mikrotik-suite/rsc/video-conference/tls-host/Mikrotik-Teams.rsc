...
add action=add-dst-to-address-list address-list=Connection-Microsoft-Teams address-list-timeout=1d chain=prerouting protocol=tcp tls-host=*.lync.com* dst-address-list=!LOCAL-IP src-address-list=LOCAL-IP comment="// CONNECTION MICROSOFT TEAMS => {VIDEO CONPERENCE}"
add action=add-dst-to-address-list address-list=Connection-Microsoft-Teams address-list-timeout=1d chain=prerouting protocol=tcp tls-host=*teams.live.com* dst-address-list=!LOCAL-IP src-address-list=LOCAL-IP
add action=add-dst-to-address-list address-list=Connection-Microsoft-Teams address-list-timeout=1d chain=prerouting protocol=tcp tls-host=*.teams.* dst-address-list=!LOCAL-IP src-address-list=LOCAL-IP
