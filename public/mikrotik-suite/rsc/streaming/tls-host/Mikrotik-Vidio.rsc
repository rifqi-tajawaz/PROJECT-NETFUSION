...
add action=add-dst-to-address-list address-list=Connection-Vidio address-list-timeout=1d chain=prerouting protocol=tcp tls-host=*vidio.com* dst-address-list=!LOCAL-IP src-address-list=LOCAL-IP comment="// CONNECTION VIDIO => {STREAMING}"
add action=add-dst-to-address-list address-list=Connection-Vidio address-list-timeout=1d chain=prerouting protocol=tcp tls-host=*.vidio.* dst-address-list=!LOCAL-IP src-address-list=LOCAL-IP
