    ...
    <div class="container-fluid px-4 py-4">
        <div class="mb-4 d-flex flex-column align-items-center justify-content-center text-center">
            <h2 class="display-6 fw-bold mb-2 text-white" style="text-shadow: 0 2px 10px rgba(0,0,0,0.3);">
                <i class="bi bi-diagram-2 me-2 text-warning"></i> PPTP Server Setup
            </h2>
            <p class="lead opacity-75 mb-0" style="max-width: 700px;">
                Legacy Point-to-Point Tunneling Protocol. Fast but less secure. Useful for legacy device support.
            </p>
        </div>

        <form id="pptpForm" data-route="{{ route('mikrotik-suite.connectivity.vpn.pptp-server.generate') }}">
            <div class="row g-4">
                <div class="col-lg-5">
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control font-monospace" name="remote_address" id="remoteAddr"
                                    value="10.10.10.10-10.10.10.20">
                                <small class="text-muted">Format: IP or Range (e.g., 10.10.10.2-10.10.10.10)</small>
                            </div>
                            <div class="mb-3">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" name="auth_mschap2" id="authMschap2"
                                        value="1" checked>
                                    <label class="form-check-label text-white" for="authMschap2">Allow MS-CHAP2
                                        (Recommended)</label>
                                </div>
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" name="auth_mschap1" id="authMschap1"
                                        value="1">
                                    <label class="form-check-label text-white" for="authMschap1">Allow MS-CHAP1</label>
                                </div>
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" name="auth_pap" id="authPap" value="1">
                                    <label class="form-check-label text-white" for="authPap">Allow PAP (Insecure)</label>
                                </div>
                            </div>
...
@push('scripts')
    @vite(['resources/js/pages/mikrotik-suite/connectivity/vpn-configuration/pptp-server.js'])
@endpush
