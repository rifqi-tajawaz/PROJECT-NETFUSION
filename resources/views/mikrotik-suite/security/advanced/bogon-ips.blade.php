    ...
    <div class="container-fluid px-4 py-4">
        <div class="mb-4 d-flex flex-column align-items-center justify-content-center text-center">
            <h2 class="display-6 fw-bold mb-2 text-white" style="text-shadow: 0 2px 10px rgba(0,0,0,0.3);">
                <i class="bi bi-radioactive me-2 text-warning"></i> Bogon IPs
            </h2>
            <p class="lead opacity-75 mb-0" style="max-width: 700px;">
                Block traffic from private/reserved IP ranges on your WAN interface.
            </p>
        </div>
                    ...
                    <div class="glass-card h-100">
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="d-grid mt-4">
                                <button type="submit" class="btn btn-warning text-dark btn-lg shadow-lg">Generate Bogon
                                    Rules</button>
                            </div>
                        </div>
                    </div>
...
@push('scripts')
    @vite(['resources/js/pages/mikrotik-suite/security/advanced/bogon-ips.js'])
@endpush
