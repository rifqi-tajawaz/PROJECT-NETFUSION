...
add action=add-dst-to-address-list address-list=Connection-Vimeo address-list-timeout=1d chain=prerouting content=vimeo.com dst-address-list=!LOCAL-IP src-address-list=LOCAL-IP comment="// CONNECTION VIMEO => {STREAMING}"
add action=add-dst-to-address-list address-list=Connection-Vimeo address-list-timeout=1d chain=prerouting content=.vimeo. dst-address-list=!LOCAL-IP src-address-list=LOCAL-IP
