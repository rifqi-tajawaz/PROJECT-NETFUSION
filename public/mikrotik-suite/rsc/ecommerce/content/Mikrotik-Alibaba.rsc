...
add action=add-dst-to-address-list address-list=Connection-Alibaba address-list-timeout=1d chain=prerouting content=alibaba.com dst-address-list=!LOCAL-IP src-address-list=LOCAL-IP comment="// CONNECTION ALIBABA => {MARKETPLACE}"
add action=add-dst-to-address-list address-list=Connection-Alibaba address-list-timeout=1d chain=prerouting content=.alibaba. dst-address-list=!LOCAL-IP src-address-list=LOCAL-IP
