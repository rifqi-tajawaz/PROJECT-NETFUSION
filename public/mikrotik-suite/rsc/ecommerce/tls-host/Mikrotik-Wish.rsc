...
add action=add-dst-to-address-list address-list=Connection-Wish address-list-timeout=1d chain=prerouting protocol=tcp tls-host=*wish.com* dst-address-list=!LOCAL-IP src-address-list=LOCAL-IP comment="// CONNECTION WISH => {MARKETPLACE}"
add action=add-dst-to-address-list address-list=Connection-Wish address-list-timeout=1d chain=prerouting protocol=tcp tls-host=*.wish.* dst-address-list=!LOCAL-IP src-address-list=LOCAL-IP
